...
namespace Actividad_II___Ingenieria_de_software_II___MVC.VISTA
{
    public partial class EditGrades : Form
    {
        ...
        public EditGrades()
        {
            ...
            RefrescarTabla();
            dtGrades.Columns[0].HeaderText = "Id de usuario";
            dtGrades.Columns[1].HeaderText = "Id de materia";
        ...
        {
            _gradesController.EditarCalificaciones(int.Parse(idBox.Text), int.Parse(subjectBox.Text), decimal.Parse(gradesBox.Text));
            RefrescarTabla();
        }
